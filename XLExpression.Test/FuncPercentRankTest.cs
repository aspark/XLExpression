...
{
    public class FuncPercentRankTest
    {
        [Fact]
        public void Test1()
        {
            var exp = ExpressionBuilder.Instance.Build("PercentRank(F2:H3, 6)");
        ...
        public void Test2()
        {
            var exp = ExpressionBuilder.Instance.Build("PercentRank(F2:H3, E2)");
            ...
            exp = ExpressionBuilder.Instance.Build("PercentRank(F2:H4, E2, 6)");

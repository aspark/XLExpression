...
{
    public class FuncPercentileIncTest
    {
        [Fact]
        public void Test1()
        {
            var exp = ExpressionBuilder.Instance.Build("Percentile.Inc(F2:H3, 0.5)");
            ...
            exp = ExpressionBuilder.Instance.Build("Percentile.Inc(F2:H3, 50%)");

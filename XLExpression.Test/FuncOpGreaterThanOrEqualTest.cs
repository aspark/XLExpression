...
{
    public class FuncOpGreaterThanOrEqualTest
    {
        [Fact]
        public void Test1()
        {
        ...
        public void Test2()
        {
            var exp = ExpressionBuilder.Instance.Build("1>=-9");
        ...
        public void Test4()
        {
            ...
            result = exp.Invoke(new { A1 = 4, B2 = 3 });
            ...
            result = exp.Invoke(new { A1 = new DateTime(2022, 11, 21), B2 = "2022-11-21" });
            result.ShouldBe(true);

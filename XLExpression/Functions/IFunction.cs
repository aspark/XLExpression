...
namespace XLExpression.Functions
{
    ...
    {
        object? Invoke(IFunctionDataContext dataContext, object[] args);
    }
    ...
    {
        public abstract object? Invoke(IFunctionDataContext dataContext, object[] args);
        ...
        /// <returns></returns>
        public object[] UnwarpArgs(IFunctionDataContext dataContext, object[] args)//, bool isRange = false
        {
            if (args == null)
                return new object[0];
